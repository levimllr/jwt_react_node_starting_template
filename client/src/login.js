...
class Login extends Component {
    ...
    /* In order to utilize our authentication methods within the AuthService 
    class, we want to instantiate a new object */
    ...
    handleFormSubmit = (e) => {
        ...
        button, we would like to utilize a login method that will send our 
        entered credentials over to the server for verification. 
        Once verified, it should store your token and send you to the protected 
        route. */

        this.Auth.login(this.state.username, this.state.password)
            .then(response => {
                if (response === false) {
                    return alert("Sorry, those credientials don't exit!");
                };
